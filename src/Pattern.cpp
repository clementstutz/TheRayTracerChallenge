...
bool Pattern::operator==(Pattern const& other) const {
	// V�rification de type avec typeid
...
Color Pattern::PatternAtObject(Point const& objectPoint) const {
	// � d�placer dans patternAt pour que les transformations de chaque sous-pattern soient aussi prises en compte.
	// Le point est d�j� converti de l'espace global vers l'espace local de l'objet.
